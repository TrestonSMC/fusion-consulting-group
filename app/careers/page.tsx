...
export default function CareersPage() {
  return (
    <main className="min-h-screen bg-[#F8F8F6] pt-28 md:pt-32">
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 md:py-20">
          <div className="grid gap-10 lg:grid-cols-12 lg:items-start">
            <div className="lg:col-span-7">
              ...
              <div className="mt-6 h-[3px] w-20 rounded-full bg-[#C8A96B]" />
              ...
              <p className="mt-4 max-w-3xl text-base leading-relaxed text-[#0B1F3A]/65 md:text-lg">
            ...
            <div className="lg:col-span-5">
              <div className="rounded-[32px] border-2 border-[#C8A96B]/45 bg-[#F8F8F6] p-8 shadow-[0_14px_40px_rgba(11,31,58,0.08)] md:p-10">
                <p className="text-xs font-semibold tracking-[0.22em] text-[#C8A96B]">
                  FUTURE HIRING FOCUS
                </p>
                <h2 className="mt-3 text-2xl font-semibold text-[#0B1F3A] md:text-3xl">
                  Areas we expect to grow
                </h2>
                <p className="mt-4 text-sm leading-relaxed text-[#0B1F3A]/65 md:text-base">
                ...
                <div className="mt-6 grid gap-3 sm:grid-cols-2">
                  {industries.map((item) => (
                    <div
                      key={item}
                      className="rounded-2xl border border-[#C8A96B]/25 bg-white px-4 py-3 text-sm text-[#0B1F3A]/70"
                    >
                      {item}
                    </div>
                  ))}
      ...
      <section id="future-roles" className="bg-[#F8F8F6]">
        <div className="mx-auto max-w-7xl px-6 py-16">
          ...
          <div className="mt-12 grid gap-6 xl:grid-cols-2">
            {roleCards.map((role) => (
              <div
                key={role.title}
                className="rounded-[30px] border border-[#C8A96B]/25 bg-white p-8 shadow-[0_12px_35px_rgba(11,31,58,0.06)]"
              >
                <div className="flex flex-wrap items-center gap-3">
                  <div className="inline-flex rounded-full bg-[#0B1F3A] px-4 py-1 text-xs font-semibold tracking-[0.18em] text-[#C8A96B]">
                    {role.subtitle.toUpperCase()}
                  </div>
                </div>

                <h3 className="mt-5 text-2xl font-semibold leading-snug text-[#0B1F3A]">
                  {role.title}
                </h3>

                <div className="mt-6">
                  <p className="text-sm font-semibold uppercase tracking-[0.18em] text-[#C8A96B]">
                    Overview
                  </p>
                  <p className="mt-3 text-sm leading-relaxed text-[#0B1F3A]/65 md:text-base">
                    {role.overview}
                  </p>
                </div>
                ...
                <div className="mt-6">
                  ...
                  <div className="mt-3 space-y-3">
                    {role.bullets.map((item) => (
                      <div
                        key={item}
                        className="flex gap-3 rounded-2xl border border-[#C8A96B]/20 bg-[#F8F8F6] px-4 py-3"
                      >
                ...
                <div className="mt-6">
                  ...
                  <div className="mt-3 space-y-3">
                    {role.qualifications.map((item) => (
                      <div
                        key={item}
                        className="flex gap-3 rounded-2xl border border-[#C8A96B]/20 bg-white px-4 py-3"
                      >
                        <span className="mt-2 inline-flex h-2.5 w-2.5 flex-none rounded-full bg-[#C8A96B]" />
                        <p className="text-sm leading-relaxed text-[#0B1F3A]/70">
                          {item}
        ...
        <div className="mx-auto max-w-7xl px-6 py-16">
          <div className="grid gap-10 lg:grid-cols-12 lg:items-start">
            <div className="lg:col-span-5">
              ...
              <p className="mt-5 text-sm leading-relaxed text-[#0B1F3A]/60 md:text-base">
            ...
            <div className="lg:col-span-7">
              <div className="grid gap-4 sm:grid-cols-2">
                {thrivePoints.map((item) => (
                  <div
                    key={item}
                    className="rounded-3xl border border-[#C8A96B]/25 bg-white p-6 shadow-[0_10px_28px_rgba(11,31,58,0.05)]"
                  >
                    <div className="flex items-start gap-3">
                      <span className="mt-1 inline-flex h-3 w-3 flex-none rounded-full bg-[#C8A96B]" />
                      <p className="text-sm leading-relaxed text-[#0B1F3A]/70">
                        {item}
                      </p>
                    </div>
      ...
      <section className="relative overflow-hidden bg-[#0B1F3A]">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-20">
          <div className="grid gap-10 lg:grid-cols-12">
            ...
            <div className="lg:col-span-5">
              <div className="rounded-3xl border border-[#C8A96B]/35 bg-white/10 p-8 backdrop-blur">
                <p className="text-xs font-semibold tracking-[0.2em] text-[#C8A96B]">
                  CAREERS CONTACT
                </p>
                ...
                <div className="mt-6">
                  <a
                    href="mailto:Careers@fcghelps.com"
                    className="inline-flex w-full items-center justify-center rounded-2xl bg-[#C8A96B] px-6 py-3 text-sm font-semibold text-[#0B1F3A] transition hover:bg-[#d8bb7c]"
                  >
                ...
                <div className="mt-3">
                  <Link
                    href="/contact"
                    className="inline-flex w-full items-center justify-center rounded-2xl border border-[#C8A96B]/40 bg-white/10 px-6 py-3 text-sm font-semibold text-white transition hover:bg-white/15"
                  >
                    Visit Contact Page
                  </Link>
                </div>
