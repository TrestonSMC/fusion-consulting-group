      ...
      <section className="bg-white">
        <div className="mx-auto max-w-5xl px-6 py-16 md:py-20">
          ...
          <p className="mt-5 max-w-3xl text-base leading-relaxed text-[#0B1F3A]/70 md:text-lg">
            Requirements engineering and functional decomposition initiative
            built to translate complex business and engineering workflows into
            traceable, testable system requirements supporting enterprise EPMS
            platform evaluation.
          </p>
          ...
          <div className="space-y-12">
            <ContentBlock title="Project Description">
              <p>
                ...
                organization and Corporate IT of a large electric utility to
                develop a comprehensive IT Project Charter and Azure DevOps
                (ADO) functional requirements framework for the Enterprise
                Project Management System (EPMS) program.
              </p>
              ...
              <p>
                ...
                Transmission & Distribution—along with Corporate IT leadership.
                The organization was assessing whether to continue investing in
                existing and evolving platforms, including internal construction
                and project management solutions, or to transition to alternative
            ...
            <ContentBlock title="Solution Overview">
              <p>
                ...
                large-scale enterprise construction and project management
                systems.
              </p>

              <p>
                The work emphasized governance, clarity, and testability,
                ensuring all requirements were measurable, traceable, and aligned
                with enterprise standards. By creating a consistent framework
                within Azure DevOps, the utility gained a more disciplined and
                defensible basis for strategic system evaluation.
              </p>
            </ContentBlock>

            <ContentBlock title="Scope of Work & Capabilities">
              <p>
                Fuzion delivered a comprehensive documentation and analysis
                effort that included development of an EPMS IT Project Charter
                aligned with enterprise governance standards, documentation of
                current-state and future-state architecture and infrastructure,
                and mapping of engineering and business processes across
                Generation, Operations, and T&amp;D.
              </p>

              <p>
                The engagement also included decomposition of business
                requirements into functional requirements, definition of
                non-functional requirements such as performance, security,
                scalability, and compliance, and structured functional
                decomposition into epics, features, and user stories within Azure
                DevOps.
              </p>

              <p>
                Fuzion established clear, testable acceptance criteria for each
                requirement, aligned requirements with project stage gates 1–5
                and operational workflows, and created a structured ADO framework
                that supported objective vendor and platform comparison.
              </p>
            </ContentBlock>
            ...
            <ContentBlock title="Business Impact">
              <p>
                ...
                establishing a clear and traceable link between business needs
                and system functionality.
              </p>

              <p>
                The resulting framework reduced risk by ensuring requirements
                were explicit, measurable, and testable, while also supporting
                informed executive decision-making with defensible documentation.
                It gave the organization a clearer basis for comparing major
                platform options without relying on assumptions or incomplete
                business logic.
              </p>
            ...
            <ContentBlock title="Strategic Value">
              <p>
                ...
                vendor-neutral decision framework. This approach enabled
                leadership to compare multi-million-dollar SaaS alternatives
                against internally developed and modernized platforms without
                bias, ambiguity, or reliance on vendor marketing claims.
              </p>

              <p>
                The engagement reinforced Fuzion’s role as a trusted advisor
                capable of bridging business strategy, engineering operations,
                and enterprise IT governance. Rather than focusing only on
                technical delivery, the work positioned Fuzion at the center of
                strategic technology evaluation and investment planning.
              </p>
            </ContentBlock>
            ...
            <ContentBlock title="Why This Matters">
              <p>
                ...
                technology investment decisions in regulated utility
                environments, translate business strategy into actionable and
                testable technical requirements, and lead cross-functional
                alignment across multiple business units and Corporate IT.
              </p>

              <p>
                It also demonstrates Fuzion’s strength in applying disciplined
                requirements engineering and governance practices at scale,
                helping organizations make high-value technology decisions with
                greater confidence, clarity, and structure.
              </p>
            </ContentBlock>
          </div>
        </div>
